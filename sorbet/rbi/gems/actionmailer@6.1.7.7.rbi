...
class ActionMailer::Base < ::AbstractController::Base
  ...
  # source://actionview/6.1.7.7/lib/action_view/layouts.rb#325
  ...
  class << self
    ...
    # source://actionview/6.1.7.7/lib/action_view/layouts.rb#209
    def _layout; end
    ...
    # source://actionview/6.1.7.7/lib/action_view/layouts.rb#210
...
module ActionMailer::Base::HelperMethods
  ...
  # source://actionpack/6.1.7.7/lib/abstract_controller/caching/fragments.rb#31
  def combined_fragment_cache_key(*args, **_arg1, &block); end

  # source://actionpack/6.1.7.7/lib/abstract_controller/caching.rb#43
...
class ActionMailer::DeliveryJob < ::ActiveJob::Base
  ...
  class << self
    ...
    # source://activejob/6.1.7.7/lib/active_job/queue_name.rb#56
    def queue_name; end
